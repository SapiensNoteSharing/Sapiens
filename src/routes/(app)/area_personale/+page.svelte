...
<div>
    <!-- Account Info -->
    <div class="px-5 pt-5 scrollspy-example-2" data-bs-spy="scroll" data-bs-target="#personal_area_scrollspy" data-bs-smooth-scroll="true">
    ...
    <!-- Preferences -->
    <div class="px-5 pt-5">
        <h2 class="display-6" id="preference">Preferenze</h2>
    </div>
</div>
